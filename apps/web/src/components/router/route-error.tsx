    ...
    <div className="flex-1 min-h-0 overflow-y-auto">
      <div className="container py-14">
        <div className="max-w-xl space-y-3">
          <p className="text-xs font-bold tracking-widest text-muted-foreground uppercase">Error</p>
          <h1 className="text-2xl sm:text-3xl font-display font-bold tracking-tight">Something broke</h1>
